                                                ...
                                                <table class="ui-table ui-table-list" data-page-size="20"
                                                    ...
                                                    {pg:section name=vv loop=$data}
                                                            <tr class="widget-list-item">
                                                                ...
                                                                <td>{pg:$data[vv].cardType}</td>
                                                                <td>{pg:$data[vv].shop}</td>
                                                                <td>{pg:$data[vv].Status}</td>
                                                                <td>{pg:$data[vv].cardAmount}</td>
                                                                <td>{pg:$data[vv].cardMortgageAmount}</td>
                                                                <td>{pg:$data[vv].cardTotalAmount}</td>
                                                                <td>{pg:$data[vv].cardAmount_Sys}</td>
                                                                <td>{pg:$data[vv].cardMortgageAmount_Sys}</td>
                                                                <td>{pg:$data[vv].cardTotalAmount_Sys}</td>
                                                                <td>{pg:$data[vv].lastChangeAmount}</td>
                                                                <td>{pg:$data[vv].lastChangeTime}</td>
                                                                <td>{pg:$data[vv].enableTime}</td>
                                                                <td>{pg:$data[vv].createTime}</td>
                                                                <td>{pg:$data[vv].correctingTime}</td>
                                                                <td>{pg:$data[vv].note}</td>
                                                                {pg:if $data[vv].cardStatus eq Y}
                                                                    <td class="footable-last-column">
                                                                        <a>
                                                                            <button
                                                                                onclick="return card_freeze({pg:$data[vv].cardNo})"
                                                                                class="btn btn-primary btn-small">
                                                                                冻结
                                                                            </button>
                                                                        </a>
                                                                    </td>
                                                                {pg:elseif $data[vv].cardStatus eq D}
                                                                    <td class="footable-last-column">
                                                                        <a>
                                                                            <button
                                                                                onclick="return card_unfreeze({pg:$data[vv].cardNo})"
