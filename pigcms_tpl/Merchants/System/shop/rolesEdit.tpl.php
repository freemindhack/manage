...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
				<form id="rolesForm" class="form" action="?m=User&c=system&a=rolesAppemd" method="post">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
							<div class="form-group">
								...
								<input type="text" id="username" placeholder="请输入员工名称" name="rolename" value="<?php echo $roles['rolename'];?>" class="form-control required" aria-required="true">
							</div>
                        </div>
                    </div>
                </div>
									...
									<div class="part_item">
										...
										<div class="part_item_b">
											<?php foreach($val as $k=>$v){?>
												<p><input type="checkbox" name="authority[]" <?php if(in_array('Merchants/User/'.$key.'/'.$k,$roles['authority'])){ echo 'checked'; }?> value="<?php echo 'Merchants/User/'.$key.'/'.$k;?>"><?php echo $v; ?></p>
											<?php } ?>
										</div>
									</div>
								<?php } ?>
