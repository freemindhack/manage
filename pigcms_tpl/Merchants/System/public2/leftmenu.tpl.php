            ...
            <ul id="side-menu" class="nav metismenu">
                ...
                <li <?php if(ROUTE_CONTROL=='system') echo 'class="active"';?>>
                    ...
                    <ul class="nav nav-second-level collapse <?php if(ROUTE_CONTROL=='system') echo 'in';?>">
                        <li <?php if(ROUTE_CONTROL=='system' && ROUTE_ACTION=='roles') echo 'class="active"';?>><a href="/merchants.php?m=User&c=system&a=roles">角色管理</a></li>
                    </ul>
                </li>
				<li <?php if(ROUTE_CONTROL=='merchant') echo 'class="active"';?>>
                    ...
                    <ul class="nav nav-second-level collapse <?php if(ROUTE_CONTROL=='merchant') echo 'in';?>">
                        <li <?php if(ROUTE_CONTROL=='merchant' && ROUTE_ACTION=='employers') echo 'class="active"';?>><a href="/merchants.php?m=User&c=merchant&a=employers">操作员管理</a></li>
                    </ul>
                </li>
                ...
                <li <?php if(ROUTE_CONTROL=='shop') echo 'class="active"';?>>
                    ...
                    <ul class="nav nav-second-level collapse <?php if(ROUTE_CONTROL=='shop') echo 'in';?>">
                        <li <?php if(ROUTE_CONTROL=='shop' && ROUTE_ACTION=='manageShop') echo 'class="active"';?>><a href="/merchants.php?m=User&c=shop&a=manageShop">商户管理</a></li>
                    </ul>
                </li>
                <li <?php if(ROUTE_CONTROL=='card') echo 'class="active"';?>>
                    ...
                    <ul class="nav nav-second-level collapse <?php if(ROUTE_CONTROL=='card') echo 'in';?>">
                        <li <?php if(ROUTE_CONTROL=='card' && ROUTE_ACTION=='card_status') echo 'class="active"';?>><a href="/merchants.php?m=User&c=card&a=card_status">卡状态管理</a></li>
                        <li <?php if(ROUTE_CONTROL=='card' && ROUTE_ACTION=='card_liushui') echo 'class="active"';?>><a href="/merchants.php?m=User&c=card&a=card_liushui">卡流水管理</a></li>
                    </ul>
                </li>
                <li <?php if(ROUTE_CONTROL=='report') echo 'class="active"';?>>
                    ...
                    <ul class="nav nav-second-level collapse <?php if(ROUTE_CONTROL=='report') echo 'in';?>">
                        <li <?php if(ROUTE_CONTROL=='report' && ROUTE_ACTION=='report_qindan') echo 'class="active"';?>><a href="/merchants.php?m=User&c=report&a=report_qindan">交易清单查询</a></li>
                        <li <?php if(ROUTE_CONTROL=='report' && ROUTE_ACTION=='report_tongji') echo 'class="active"';?>><a href="/merchants.php?m=User&c=report&a=report_tongji">商户日销售统计</a></li>
                    </ul>
                </li>
