	...
	<link href="<?php echo $this->RlStaticResource; ?>plugins/css/datetimepicker/bootstrap-datetimepicker.min.css"
		  rel="stylesheet">
	<!-- Mainly scripts -->
	...
	<script
		src="<?php echo $this->RlStaticResource; ?>plugins/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
	<script
		src="<?php echo $this->RlStaticResource; ?>plugins/js/datetimepicker/bootstrap-datetimepicker.zh-CN.js"></script>
