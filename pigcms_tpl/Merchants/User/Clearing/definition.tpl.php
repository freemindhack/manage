                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8" data-filter=#filter>
								...
								<?php if(!empty($feelist)){
								 ...
								 foreach($feelist as $key=>$val){ ?>
                                <tr>
                                    <td class="check-mail"><input type="checkbox" class="i-checks" value="<?php echo $feelist['id'];?>" name="id[]"></td>
                                    ...
                                    <td class="center">
										<div class="btn-group">
                                            <a href="javascript:void(0)" class="btn btn-white btn-sm employersEdit" data-id="<?php echo $val['id'];?>"><i class="fa fa-pencil"></i> 修改</a>
