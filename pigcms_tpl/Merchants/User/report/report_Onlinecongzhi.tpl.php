            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox-content">
                        ...
                        <form class="form-search form-inline" id="report" action="?m=User&c=report&a=report_onlineczSea"
                              method="post">
...
<script>
    $(function () {
        ...
        $("#exprot").click(function () {
            if(GetQueryString("a")=="report_Onlinecongzhi"){
                swal("请查找后在导出！！");
            }else {
