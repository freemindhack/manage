            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox-content">
                        <label><span style="">日充值赠送统计:</span></label>
                        <form class="form-search form-inline" id="report" action="?m=User&c=report&a=zsdaysea"
                              method="post">
                            <input type="text" name="deviceno"  style="height:auto"
                                   placeholder="充值款台号码" value="<?php echo $data['deviceno'];?>"/>
                                ...
                                <div>
                                    ...
                                    <div class="cashier-realtime">
                                        <div class="realtime-title-block clearfix">
                                            <h1 class="realtime-title btn-sm">日充值赠送统计</h1>
                                                    ...
                                                    <?php if (!empty($result)) {
                                                        foreach ($result as $rvv) {
                                                            ...
                                                            <tr class="widget-list-item">
                                                                ...
                                                                <td><?php echo $rvv['t']; ?></td>
                                                                <td><?php echo $rvv['total']; ?></td>
                                                            </tr>
                                                        <?php }?>
                                                    <?php } else { ?>
                                                        <tr class="widget-list-item">
