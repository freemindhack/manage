    ...
    <div id="wrapper">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
				...
				<input type="hidden" name="mid" value="<?php echo $employee['mid'];?>">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
							<div class="form-group">
								<label><span class="mustInput">*</span>员工名称:<span class="f999">(20字以内)</span></label>
								<input type="text" id="username" placeholder="请输入员工名称" name="wxname" value="<?php echo $employee['wxname'];?>" class="form-control required" aria-required="true">
							</div>
							<div class="form-group">
								<label><span class="mustInput">*</span>登录账号:</label>
								<input type="text" id="account" placeholder="请输入登录账号" name="username" value="<?php echo $employee['username'];?>" class="form-control required" aria-required="true">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<select  class="form-control required " aria-required="true" data-style="btn-success" name="roleid" id="roleid">
									<?php foreach ($roles as $k=>$v){?>
										<option value="<?php echo $v['id']?>" <?php if ($v['id']==$employee['roleid']){ echo "selected";} ?>><?php echo $v['rolename']?></option>
									<?php }?>
								</select>
							</div>
                        </div>
