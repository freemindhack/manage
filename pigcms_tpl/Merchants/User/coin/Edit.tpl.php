...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
				<form id="employersForm" class="form" action="?m=User&c=coin&a=Appemd" method="post">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
							<div class="form-group">
								...
								<input type="text" id="username" placeholder="请输入员工名称" name="Name" value="<?php echo $data['Name'];?>" class="form-control required" aria-required="true">
							</div>
							<div class="form-group">
								<label><span class="mustInput">*</span>员工号:</label>
								<input type="text" id="account" placeholder="请输入登录账号" name="Number" value="<?php echo $data['Number'];?>" class="form-control required" aria-required="true">
							</div>
							<div class="form-group">
								<label></span>密码:</label>
								<input type="text" id="password" placeholder="不修改密码则不需要填写(6到20个字符)" name="Pwd" class="form-control">
							</div>
