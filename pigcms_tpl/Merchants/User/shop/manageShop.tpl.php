                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="12" data-filter="#filter">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $val['bank_account'];?></td>
								...
								<?php }}else{ ?>
								<tr><td colspan="8" style="text-align: center; font-size: 16px;">没有商户,请添加！</td></tr>
								<?php }?>
                                </tbody>
                            </table>
							</form>
							...
							<div class="ibox">
                        		...
                        		<div class="ibox-content">
                            		<div class="form-group">
										...
										<input type="text"  id="shopname" placeholder="请输入商户名称" name="shopname" class="form-control required" aria-required="true">
									</div>
                                    <div class="form-group">
                                        <label><span class="mustInput">*</span>商户登录帐号:</label>
                                        <input type="text"  id="UserName" placeholder="请输入用户名" name="UserName" class="form-control required" aria-required="true">
                                    </div>
                                    <div class="form-group">
                                        <label><span class="mustInput">*</span>登录密码:</label>
                                        <input type="text"  id="PassWord" placeholder="请输入密码" name="PassWord" class="form-control required" aria-required="true">
                                    </div>
                                    <div class="form-group">
                                        <label>联系人:</label>
                                        <input type="text"  id="Contacts" placeholder="请输入联系人" name="Contacts" class="form-control">
                                    </div>
									<div class="form-group">
										<label>联系方式:</label>
										<input type="text"  id="tel" placeholder="请输入联系方式" name="Phone" class="form-control">
									</div>
									<div class="form-group">
										<label>户名:</label>
										<input type="text"  id="bank_account" placeholder="请输入户名" name="bank_account" class="form-control" >
									</div>
									<div class="form-group">
										<label>开户行:</label>
										<input type="text"  id="bank" placeholder="请输入开户行" name="bank" class="form-control" >
									</div>
									<div class="form-group">
										<label>银行账号:</label>
										<input type="text"  id="card_num" placeholder="请输入银行账号" name="card_num" class="form-control" >
									</div>
                        		</div>
                    		</div>
						</div>
