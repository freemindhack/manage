                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            ...
                            <form target="_blank" action="?m=User&c=print&a=printSelectNotice" class="employersDelAll"
                                  method="post">
                                    ...
                                    <?php if (!empty($vender)) {
                                        ...
                                        foreach ($vender as $key => $val) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo date('Y-m',strtotime('-1 month')); ?></td>
                            ...
                            <div class="tooltip-demo">
                                ...
                                <a class="btn btn-white btn-sm" data-toggle="tooltip"
                                   href="?m=User&c=print&a=printallNotice" target="_blank"
