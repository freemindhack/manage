                ...
                <div class="subpage">
                    ...
                    <table border="1px solid black" cellpadding="1" cellspacing="0" width="100%">
                        ...
                        <?php foreach ($value['data'] as $k => $v) {
                            echo '<tr><td>' .substr($v['check_date'],6)  . '</td>' . '<td>' . $v['sy_ck'] . '</td>' . '<td>' . $v['sy_wx'] . '</td>' . '<td>' . $v['sy_zfb'] . '</td>' . '<td>' . $v['sg_wx'] . '</td>' . '<td>' . $v['sg_zfb'] . '</td>' . '<td>' . $v['sg_mt'] . '</td>' . '<td>' . $v['sg_dzdp'] . '</td>' . '<td>' . $v['sg_lm'] . '</td>' . '<td>' . $v['sg_dyqcz'] . '</td>' . '<td>' . $v['sg_xj'] . '</td>' . '<td>' . $v['sg_yhnk'] . '</td>' . '<td>' . $v['sg_yhwk'] . '</td>' . '<td>' . $v['sum'] . '</td></tr>';
                        } ?>
