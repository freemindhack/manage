                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <form action="?m=User&c=qita&a=delall" class="rolesDelAll" method="post">
                                <table class="footable table table-bordered toggle-arrow-tiny" data-page-size="10"
                                    ...
                                    <?php if (!empty($data)) {
                                        foreach ($data as $key => $val) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $val['sg_elm']; ?></td>
                                                <td><?php echo $val['sg_dwb']; ?></td>
                                                <td><?php echo $val['sg_dyqcz']; ?></td>
                                                <td><?php echo $val['sg_xj']; ?></td>
                                                <td><?php echo $val['sg_yhnk']; ?></td>
                                                <td><?php echo $val['sg_yhwk']; ?></td>
                                                <td><?php echo $val['sg_zz']; ?></td>
                                                <td><?php echo $val['hj']; ?></td>
                                                <td><?php echo $val['shbz']; ?></td>
                                                <td class="center">
                                                    <div class="btn-group">
                                                        <a href="?m=User&c=qita&a=qitaEdit&id=<?php echo $val['id']; ?>" <?php if ($val['shbz'] == "Y") echo 'disabled'; ?>
                                        ...
                                        <tr>
                                            <td colspan="19" style="text-align: center; font-size: 16px;">没有数据</td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
...
<script type="text/html" id="employersEditTpl">
    <figure>
        <iframe width="425" height="349" src="?m=User&c=qita&a=qitaEdit&id={($id)}" frameborder="0"></iframe>
    </figure>
</script>
