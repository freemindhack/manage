            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox-content">
                        ...
                        <form class="form-search form-inline" id="card_infoma" action="?m=User&c=card&a=card_infoma"
                              method="post">
                              <select name="cardStatus" class="input-medium search-query" style="height:auto;width: auto">
                                                    ...
                                                    <?php if (!empty($data)) {
                                                        foreach ($data as $rvv) {
                                                            ...
                                                            <tr class="widget-list-item">
                                                                ...
                                                                <td><?php echo $rvv['shop']; ?></td>
                                                                <td><?php echo $cardStatus[$rvv['cardStatus']]; ?></td>
                                                                <td><?php echo $rvv['cardAmount']; ?></td>
                                                                <td><?php echo $rvv['cardMortgageAmount']; ?></td>
                                                                <td><?php echo $rvv['cardTotalAmount']; ?></td>
                                                                <td><?php echo $rvv['cardAmount_Sys']; ?></td>
                                                                <td><?php echo $rvv['cardMortgageAmount_Sys']; ?></td>
                                                                <td><?php echo $rvv['cardTotalAmount_Sys']; ?></td>
                ...
                <div class="ui-box" style="padding-left: 30px;">
                    <h2>合计:</h2>
                    <table class="ui-table ui-table-list" data-page-size="20"
                           style="padding: 0px;">
                        <thead class="js-list-header-region tableFloatingHeaderOriginal">
                        ...
                        <tbody>
                        <tr>
                            <td><?php echo $sum[0]['total1']; ?></td>
                            <td><?php echo $sum[0]['total2']; ?></td>
                            <td><?php echo $sum[0]['total3']; ?></td>
                            <td><?php echo $sum[0]['total4']; ?></td>
                            <td><?php echo $sum[0]['total5']; ?></td>
                            <td><?php echo $sum[0]['total6']; ?></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
