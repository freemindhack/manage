            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox-content">
                        ...
                        <form id="xinxi1" action="?m=User&c=card&a=card_OnlineliushuiSea"   method="post">
                            <input id="cardNo" type="text" style="height:auto"   placeholder="请输入卡号" name="cardNo"/>
                            <input type="text" name="dtbegin" id="datepicker1" style="height:auto"    placeholder="请选择开始时间"/>
                                                    ...
                                                    <?php if (!empty($result)) {
                                                        foreach ($result as $rvv) {
                                                            ...
                                                            <tr class="widget-list-item">
                                                                ...
                                                                <td><?php echo $names[$rvv['SYYId']]; ?></td>
