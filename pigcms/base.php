...
class bpBase {
    ...
    public static function loadfont($classname){
        if (file_exists(RL_PIGCMS_CORE_PATH.'libs'.DIRECTORY_SEPARATOR.'org/font'.DIRECTORY_SEPARATOR.$classname.'.ttf')) {
            $str=RL_PIGCMS_CORE_PATH.'libs'.DIRECTORY_SEPARATOR.'org/font'.DIRECTORY_SEPARATOR.$classname.'.ttf';
            return $str;
        }
    }
	/**
