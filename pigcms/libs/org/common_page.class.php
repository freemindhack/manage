...
class Page{
    ...
    public function show($type=1){
		...
		$str = '<div class="col-sm-6" id="commonpage"><div id="editable_paginate" class="dataTables_paginate paging_simple_numbers"><ul class="pagination"><li id="editable_previous" class="paginate_button previous"  ><span id="row_count">第'.$now.'页 / 共'.$total.' 页 '.($type==1 ? '&nbsp;&nbsp;':'&nbsp;&nbsp;&nbsp;&nbsp;').'</span></li>';
		if($now > 1){
