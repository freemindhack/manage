<?php /* Smarty version 2.6.18, created on 2016-07-22 17:29:42
         compiled from D:%5CphpStudy%5CWWW%5Cmanagecms%5C./pigcms_tpl/Merchants/System/shop/manageShop.tpl.php */ ?>
<!DOCTYPE html>
<html>
...
?>
                                    <tr>
                                        <td class="check-mail"><input type="checkbox" class="i-checks"
                                                                      value="<?php echo $this->_tpl_vars['merInfo'][$this->_sections['vv']['index']]['id']; ?>
" name="id[]">
                                        </td>
                                        <td><?php echo $this->_tpl_vars['merInfo'][$this->_sections['vv']['index']]['id']; ?>
</td>
                                        <td><?php echo $this->_tpl_vars['merInfo'][$this->_sections['vv']['index']]['shopname']; ?>
</td>
                                        <td><?php echo $this->_tpl_vars['merInfo'][$this->_sections['vv']['index']]['contacts']; ?>
</td>
                                        <td><?php echo $this->_tpl_vars['merInfo'][$this->_sections['vv']['index']]['tel']; ?>
</td>
                                        <td><?php echo $this->_tpl_vars['merInfo'][$this->_sections['vv']['index']]['bank_account']; ?>
</td>
                                        <td><?php echo $this->_tpl_vars['merInfo'][$this->_sections['vv']['index']]['bank']; ?>
</td>
                                        <td><?php echo $this->_tpl_vars['merInfo'][$this->_sections['vv']['index']]['card_num']; ?>
</td>
                                        <td class="center">
                                            <div class="btn-group">
                                                <a href="javascript:void(0)" class="btn btn-white btn-sm shopEdit"
                                                   data-id="<?php echo $this->_tpl_vars['merInfo'][$this->_sections['vv']['index']]['id']; ?>
